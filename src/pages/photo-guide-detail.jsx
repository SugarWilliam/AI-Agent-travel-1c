...
export default function PhotoGuideDetail(props) {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-[#FFF9F0] via-[#FFE4E1] to-[#E0F7FA] pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-3">
        <div className="flex items-center gap-3">
          <button onClick={() => setShowVideo(!showVideo)} className="flex-1 bg-[#FF6B6B] text-white py-3 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-[#FF5252] transition-colors" style={{
          fontFamily: 'Nunito, sans-serif'
        }}>
            <Play className="w-5 h-5" />
            {showVideo ? '关闭视频' : '观看视频'}
          </button>
          <button onClick={handleShare} className="p-3 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors">
